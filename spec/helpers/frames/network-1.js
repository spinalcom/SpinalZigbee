/* One Netvox light sensor Z311G in the network */
const lightSensorFrames = require('./light-sensor-1');
...
frame['Management_LQI'] = {
  ...
  response: function (format) {
    ...
    var raw = '7E 00 2D 91 00 13 A2 00 40 A3 15 7B 00 00 00 00 80 31 00 00 01 01 00 01 00 01 60 A7 9F 1B 13 AC F5 3B B4 75 02 00 00 7A 13 00 CB 17 12 00 01 FF 35';
...
frame.devices = [ lightSensorFrames ]
